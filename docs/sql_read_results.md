...
('2024A', 5, 81.8) 
Cohort **2024A** had the highest average pre-work score (**81.8**). This may indicate stronger baseline preparation in that cohort, possibly due to differences in selection, prior experience, or support/learning conditions.
...
**8 students** scored **80+**. Most are from **Jordan**, with high scorers also from **Egypt** and **Palestine**, showing strong performance across multiple countries rather than being concentrated in one location.
...
**Lina Barakat** shows a consistent on-time submission pattern (weeks 1–3 all **submitted**) with high grades (**98, 95, 96**), suggesting strong engagement and reliable performance across tasks.